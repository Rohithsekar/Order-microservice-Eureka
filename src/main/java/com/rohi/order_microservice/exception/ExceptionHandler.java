...
public class ExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(OrderCreationFailure.class)
    public ResponseEntity<Object> handleOrderCreationFailureException(OrderCreationFailure e){
